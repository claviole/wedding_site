    ...
    <div className="registry-page">
      ...
      <section className="registry-intro">
        ...
        >
          ...
          <p className="elegant-text">
            After nearly eight beautiful years together and creating a home we love, 
            we've found that our space is filled with almost everything we need. What we 
            treasure most now are the memories we create together.
          </p>
        ...
        <div className="registry-card-container">
          ...
          >
            ...
            <p className="registry-description">
              If you'd like to help us celebrate our new life together, we would be honored to 
              receive a contribution to our honeymoon fund. Your gift will help create treasured 
              memories as we begin this exciting new chapter of our journey together.
            </p>
            <p className="accent-text">
              Because after eight years of building a home, what we cherish most are the experiences we share.
            </p>
              ...
              {showPaymentOptions && (
                ...
                >
                  ...
                  <div className="payment-buttons">
                    ...
                    >
                      <img src={venmoIcon} alt="Venmo" className="payment-icon" />
                      <span>Venmo</span>
                    </a>
                  </div>
                </motion.div>
          ...
          >
            ...
            <p className="registry-description">
              If you'd prefer to select a traditional gift, we've created a small registry with items 
              that would be meaningful additions to our home.
            </p>
            <a 
      ...
      >
        <div className="message-container">
          ...
          <p>
            More than anything, your presence on our wedding day is the greatest gift you can give us.
            We're so excited to celebrate with our closest friends and family as we start this new chapter together.
          </p>
      ...
      <div style={{ 
        ...
        <div 
          style={{ 
            height: '60px', 
            width: '220px', 
            background: 'url("../../assets/images/floral-design-with-curled-edges.png") center/contain no-repeat',
            margin: '0',
            padding: '0',
            display: 'block'
          }}
